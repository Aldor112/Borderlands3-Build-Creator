    ...
    <div className="">
      <div className="flex flex-col-gap-4 mb-12">
        <div className="flex gap-4">
          <CustomSelect
            options={trees.amara.actionSkills}
            onSelect={(option) => handleSelectChange("actionSkill1", option)}
            optionTitle="Select Action Skill"
          />
          <CustomSelect
            options={trees.amara.augments}
            onSelect={(option) => handleSelectChange("augment1", option)}
            optionTitle="Select Augment 1"
          />
          <CustomSelect
            options={trees.amara.elements}
            onSelect={(option) => handleSelectChange("element", option)}
            optionTitle="Select Element"
          />
        </div>
      </div>
