    ...
    <div className="">
      ...
      <div className="flex flex-col gap-4 mb-12">
        ...
        <div className="flex gap-4">
          ...
          <CustomSelect
            options={trees.zane.augments}
            onSelect={(option) => handleSelectChange("augment3", option)}
            optionTitle="Select Augment 3"
          />
          <CustomSelect
            options={trees.zane.augments}
            onSelect={(option) => handleSelectChange("augment4", option)}
            optionTitle="Select Augment 4"
          />
        </div>
      </div>
